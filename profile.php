...
<?php include "includes/header.php"; ?>
    ...
    <div class="container" style="width: 50%;padding-top:8%;">

        <h2 style="margin-left: 40%;">Profile</h2>
        <?php $image = $_SESSION['s_image'] ; ?>
        <img src="admin/images/<?php echo $image;?>" width="200" height="190" style="margin-left: 32%;" class="img-circle" alt="Profile">
        <br><br><br><br>
        <div class="tab" style="border-radius: 10px;background-color:rgba(0, 0, 0, 0.15);">
            <button class="tablinks" style="width: 33.33%" onclick="openCity(event, 'Personel Details')">Personal Details</button>
            <button class="tablinks" style="width: 33.33%" onclick="openCity(event, 'Tickets Booked')">Tickets Booked</button>
            <button class="tablinks" style="width: 33.33%"  onclick="openCity(event, 'Edit Details')">Edit Details</button>
        </div>
        ...
        <div id="Personel Details" class="tabcontent">
          ...
          while ($row = mysqli_fetch_assoc($select_user)) {
            ...
            <table class="table table-striped" style="width: 85%;font-size:18px;">
              <tbody>
                <tr>
                  <td><b>Username:</b> </td>
        ...
        <div id="Tickets Booked" class="tabcontent">
          ...
          while ($row = mysqli_fetch_assoc($select_user_orders)) {
            ...
            ?>
            <br>
            <table class="table table-striped" style="width:85%;border: 2px solid red;box-shadow: 5px 5px 5px;">
              <tbody>
                <tr>
...
<br><br><br>
          ...
          while ($row = mysqli_fetch_assoc($select_user_orders)) {
            ...
            ?>
            <br>
            <table class="table table-striped" style="width: 85%;border: 2px solid blue;box-shadow: 5px 5px 5px;">
              <tbody>
                <tr>
                  <td><b>Passenger Name:</b> </td>
                  <td><?php echo $passenger; ?></td>
