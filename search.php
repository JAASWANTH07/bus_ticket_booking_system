            ...
            <div class="col-md-12">
              <div id="search-bar-container" class="col-md-12" style="margin-top:10%;box-shadow:5px 5px 5px;">
                ...
                if(isset($_POST['submit'])) {
                    ...
                    //echo $date;
                    $query = "SELECT * FROM posts WHERE post_source LIKE '$source' AND post_destination LIKE '$destination%' AND post_date='$date'";
                    ...
                    if($count == 0) {
                        echo "<h1>No Buses on the given Date</h1>";
                    }
                    else {
                        ...
                        while($row = mysqli_fetch_assoc($search_query)) {
                            ...
                            <hr>
                              <h2>Similar Buses on Other dates</h2>
                            <hr>
                        <?php }
                    }


                    $query = "SELECT * FROM posts WHERE post_source LIKE '$source' AND post_destination LIKE '$destination%' ";
