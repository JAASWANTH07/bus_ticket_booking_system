    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <h2 style="margin-left: 40%;padding-top: 10%;">Registration</h2>
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" onclick="myReg()" class="btn btn-primary" name="register" style="margin-left: 45%; margin-top: 20px;">Register</button>
              </form>
