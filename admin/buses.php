                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            default: ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color:rgba(255, 13, 0, 1);"><u><b><?php echo $source . " To ". $destination?></u></b></td>
                                        <td><?php echo $intermediate_station ?></td>
                                        <!-- <td><//?php echo $category ?></td> -->
                                        <td><img width="100" height="70" src="../images/<?php echo $image ?>"></td>
                                        <td><?php echo $date ?></td>
                                        <td><?php echo $time ?></td>
                                        <td><b><?php echo $seat_cost ?><b></td>
                        ...
                        while($row = mysqli_fetch_assoc($select_posts)) {
                            ...
                            $query_new = "INSERT INTO posts(post_category_id, post_title, post_author, post_date, post_image, post_content, post_source, post_destination, post_via, post_via_time, max_seats, seat_cost, available_seats)
                            VALUES({$category}, '{$title}', '{$admin_name}', '{$date}', '{$image}', '{$bus_detail}', '{$source}', '{$destination}', '{$intermediate}', '{$via_time}', $max_seats, $seat_cost, $available_seats)";
                            }
